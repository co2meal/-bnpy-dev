...
Handles selection of a plan-of-attack for improving a current model via a birthmove.  Focuses on selecting on promising topic-word parameters in advance. 
'''
import numpy as np
...
def makeCandidateTopics_AnchorAnalysis(Q, model, nPlans=1, 
  ...
  # Find few rows of Q that best explain *all* rows of Q (together with curTopics)
