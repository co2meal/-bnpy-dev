...
class SuffStatBag(object):
  ...
  def getNumericalDims(self, dimsStr):
    ''' Takes in a string of dimensions like ('K','K') and returns the tuple of
        integers containing this SuffStag bag's dimensions
    '''
    return self._Fields._getExpectedShape(key=None, dims=dimsStr)
