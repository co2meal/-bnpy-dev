...
Initialize local params of a mixture/DP mixture model.
'''
import numpy as np
from bnpy.util import discrete_single_draw
from bnpy.data import XData

def init_local_params(hmodel, Data, initname='randexamples', seed=0, K=0, **kwargs):
  ...
  # Local parameter allocation from resp by 
  # assigning each data point to the component with highest responsibility
