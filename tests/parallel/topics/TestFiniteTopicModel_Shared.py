...
class Worker(multiprocessing.Process):
    ...
    def __init__(self, uid, JobQueue, ResultQueue,
                 ...
                 aShMem=None,
                 oShMem=None,
                 makeDataSliceFromSharedMem=None,
                 a_calcLocalParams=None,
                 o_calcLocalParams=None,
                 a_calcSummaryStats=None,
                 o_calcSummaryStats=None,
                 LPkwargs=None,
                 verbose=0):
...
class Test(unittest.TestCase):
    ...
    def setUp(self, **kwargs):
        ...
        ShMemArgs = dict(
            dataShMem=self.Data.getRawDataAsSharedMemDict(),
            aShMem=self.hmodel.allocModel.fillSharedMemDictForLocalStep(),
            oShMem=self.hmodel.obsModel.fillSharedMemDictForLocalStep(),
            a_calcLocalParams=a_L,
            a_calcSummaryStats=a_S,
