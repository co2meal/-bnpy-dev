'''
Unit tests for GaussObsCompSet
'''
from bnpy.data import XData
from bnpy.obsmodel import GaussObsCompSet
from bnpy.distr import GaussWishDistr
from bnpy.util.RandUtil import mvnrand
import unittest
import numpy as np

class TestGaussObsCompSet(unittest.TestCase):
...
class TestGaussObsCompSetVB(TestGaussObsCompSet):
  def MakeModel(self):
    ...
    self.obsM = GaussObsCompSet.InitFromCompDicts(oDict, obsPrior, compDictList)
    
class TestGaussObsCompSetEM(TestGaussObsCompSet):
  def MakeModel(self):
