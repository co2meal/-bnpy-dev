...
class TestModelReaderEMK1(unittest.TestCase):
  ...
  def setUp(self):
    ...
    self.hmodel = HModel.CreateEntireModel('EM','MixModel','ZeroMeanGauss', aPDict, oPDict, self.Data)
...
class TestModelReaderVBMixZM(unittest.TestCase):
  ...
  def setUp(self):
    ...
    self.hmodel = HModel.CreateEntireModel('VB','MixModel','ZeroMeanGauss', aPDict, oPDict, self.Data)
    initParams = dict(initname='randexamples', seed=0, K=5)
    self.hmodel.init_global_params(self.Data, **initParams)
