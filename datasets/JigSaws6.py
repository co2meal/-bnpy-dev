...
Dataset generated by motion capture of surgeons
'''
...
matfilepath = os.path.join(datasetdir, 'rawData', 'jigsaws6.mat')
...
def get_data_info():
  return 'Eighteen sequences of data from motion capture of surgeons'
